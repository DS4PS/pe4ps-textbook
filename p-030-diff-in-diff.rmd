...
So the test B2=0 is a test of whether we see any secular trends in the data. 
...
Which is the significance test associated with B3 that is reported in the model. 
