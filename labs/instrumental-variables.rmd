...
**Run a naive model that predict the effect of public housing assistance on health status. We do not consider the omitted variable bias for now. Include race, education, age, and marital status as control variables.** 
