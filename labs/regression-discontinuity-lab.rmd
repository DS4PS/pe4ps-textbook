...
* **Q2b:** Create the new variables that you need: a Treatment variable and centered rating variable. (5 points)
...
* **BQ2c** Is the estimate of the program impact consistent with the RDD model? 
* **BQ2d** Is the counterfactual for the treatment group without summer school consistent with the RDD data?
