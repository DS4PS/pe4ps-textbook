...
For this lab you need to upload the DiffInDiff_lab data available in the class R package. 
...
setwd("O:/Users/ffusi/Jesse/Labs/DiffInDiff")
data = read.csv("DiffInDiff_lab.csv")
